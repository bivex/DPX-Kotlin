"""Domain service executing pattern detection rules against Kotlin CodeModel."""
...
class RuleEngineService:
    """Evaluates rules against a CodeModel with confidence thresholding and filtering."""
