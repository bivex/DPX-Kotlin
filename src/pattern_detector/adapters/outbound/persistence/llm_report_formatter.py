"""Token-Efficient LLM / AI Prompt Context Formatter for Kotlin."""
...
class LlmReportFormatter:
    ...
    def format_scan_report(self, report: DetectionReport) -> str:
        ...
        lines: list[str] = [
            '<codebase_architecture_analysis language="kotlin">',
        ...
        if patterns:
            lines.append("    <kotlin_design_patterns_and_coroutines>")
            for d in patterns:
