"""JSON, Markdown, SARIF formatters & persistence repositories for Kotlin."""
...
class MarkdownReportFormatter(ReportFormatterPort):
    ...
    def format(self, report: DetectionReport, verbose: bool = False) -> str:
        lines = [
            f"# 🎯 DPX-Kotlin: Architectural Context & Pattern Report",
            f"",
            ...
            "runs": [
                {
                    "tool": {
                        "driver": {
                            "name": "DPX-Kotlin",
                            "informationUri": "https://github.com/bivex/DPX-Kotlin",
                            "version": "0.1.0",
                        }
                    },
                    "results": results,
